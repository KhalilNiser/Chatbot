...
class VRChatbot:
    ...
    def __init__(self):
        ...
        self.info_responses = [
            "I can provide information, answer questions, and guide you through this virtual environment.",
            "My capabilities include answering queries, offering support, and assisting with navigation.",
...
# (Would you like any additional features, such as news updates, jokes, or voice integration?)
